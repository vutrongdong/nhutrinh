...
<head>
    ...
    <link rel="stylesheet" type="text/css" href=" {{ asset('/assets/plugins/sweet-alert2/sweetalert2.min.css')}}">
                    ...
                    <li class="list-inline-item dropdown notification-list">
                        <a class="nav-link dropdown-toggle waves-effect waves-light nav-user" data-toggle="dropdown" href="#" role="button"
                           aria-haspopup="false" aria-expanded="false">
                            <img src="{{ asset('/assets/images/avatar.jpg')}}" alt="user" class="rounded-circle">
                        </a>
                        <div class="dropdown-menu dropdown-menu-right profile-dropdown " style="width: 200px;" aria-labelledby="Preview">
                            ...
                            <a class="dropdown-item notify-item" href="{{ url('/reset_pass/'.auth()->user()->id) }}">
