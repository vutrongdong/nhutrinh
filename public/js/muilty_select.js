if (!m_helper) var m_helper = {
    ...
    textField: function(a) {
        return a || (a = {}), a.tag = 'input', a.attributes || (a.attributes = {}),a.attributes.placeholder = ' Chọn danh mục cha', a.attributes.type = 'text', this.create(a)
    },
    checkbox: function(a) {
...
Multiselect.prototype = {
    ...
    _updateText: function(a) {
        ...
        b.length == document.getElementById(a._getItemListIdentifier()).querySelectorAll('ul li').length && (c = 'Tất cả đã được chọn'), document.getElementById(a._getInputFieldIdentifier()).value = c ? c : ''
    },
